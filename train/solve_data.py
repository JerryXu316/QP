...
def generate_and_save_dataset_streaming(input_csv, output_csv, flush_every=50):
    ...
    column_names = ['y(k)', 'u(k-1)', 'u(k-2)', 'u(k-3)', 'r(k)'] + [f't(k+{i})' for i in range(M)]
...
if __name__ == "__main__":
    generate_and_save_dataset_streaming("initial_generated_data.csv", "solve_generated_data.csv", flush_every=50)
